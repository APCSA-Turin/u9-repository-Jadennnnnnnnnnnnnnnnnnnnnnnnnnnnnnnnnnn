...
public class VehicleRunner {
    public static void main(String[] args) {
        ...
        Car c = new Car("KXN73F", 8.50, 2, true);
        ...
        //    Print out the calculated toll price
        Truck tr = new Truck("3K9JMX", 24.75, 4, 6, true);
        System.out.println(tr.calculateTollPrice());
        ...
        Taxi ta = new Taxi("8KM23Z", 9.25, 3, true, 5.0);
        ta.printTaxi();

        System.out.println(ta instanceof Car);
        System.out.println(ta instanceof Vehicle);
